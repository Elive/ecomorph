...
eco_list_populate(Evas_Object *list)
{
   ...
   e_widget_ilist_append(list, ico, _("Scale 'Exposé' windows"), eco_config_scale, dialog_data, NULL);
   ...
   e_widget_ilist_append(list, ico, _("Exposé Desktops"), eco_config_expo, dialog_data, NULL);
